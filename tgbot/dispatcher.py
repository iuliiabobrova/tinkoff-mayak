...
def setup_dispatcher(dp):
    ...
    for identifier in strategy_ids:
        dp.add_handler(CallbackQueryHandler(strategies_handlers.strategy_connect, pattern=f"^{identifier}$"))

    # handle strategy disconnect
    for identifier in strategy_ids:
        dp.add_handler(CallbackQueryHandler(turn_off_signals_handlers.strategy_disconnect, pattern=f"^{identifier}$"))
