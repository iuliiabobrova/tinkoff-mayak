...
def calc_strategies(figi_list: List,
    ...
    [df_historic_signals_sma_50_200, df_previous_sma_50_200] = calc_actual_signals_sma(
        n=n, df_shares=df_shares, df_hist_signals_sma=df_historic_signals_sma_list[0],
        df_all_lasts=df_all_lasts,
        df_historic_sma=df_historic_sma_list[0], df_previous_sma=df_previous_sma
    )
    [df_historic_signals_sma_30_90, df_previous_sma_30_90] = calc_actual_signals_sma(
        n=n, df_shares=df_shares, df_hist_signals_sma=df_historic_signals_sma_list[1],
        df_all_lasts=df_all_lasts,
        df_historic_sma=df_historic_sma_list[1], df_previous_sma=df_previous_sma
    )
    [df_historic_signals_sma_20_60, df_previous_sma_20_60] = calc_actual_signals_sma(
        n=n, df_shares=df_shares, df_hist_signals_sma=df_historic_signals_sma_list[2],
        df_all_lasts=df_all_lasts,
        df_historic_sma=df_historic_sma_list[2], df_previous_sma=df_previous_sma
    )
        ...
        while not market_is_closed():
            ...
            [df_historic_signals_rsi,
             ...
             n] = calc_strategies(figi_list=figi_list,
                                  df_shares=df_shares,
                                  df_historic_signals_sma=df_historic_signals_sma_list,
                                  df_historic_signals_rsi=df_historic_signals_rsi,
                                  n=n,
                                  df_close_prices=df_close_prices,
                                  df_previous_sma=df_previous_sma_list,
                                  df_historic_sma=df_sma_list)
